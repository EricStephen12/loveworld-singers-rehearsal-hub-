      ...
      <div className="bg-gray-900 px-8 py-12 relative overflow-hidden">
        ...
        <div className="absolute top-6 left-6 z-20">
          <button
            ...
            className="flex items-center gap-2 text-white hover:text-gray-300 transition-colors touch-target focus:outline-none focus:ring-0 focus:border-0 border-0 outline-none"
          >
                ...
                <div className="bg-gray-100 rounded-xl p-4 border border-gray-200">
                  <div className="flex items-center gap-3 mb-3">
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                      formData.socialProvider === 'google' ? 'bg-blue-500' : 'bg-purple-600'
                    }`}>
                    ...
                    <div>
                      <p className="text-gray-900 text-sm font-medium">
                        {formData.socialProvider === 'google' ? 'Google Account' : 'KingsChat Account'}
                      </p>
                      <p className="text-gray-600 text-xs">{formData.socialId}</p>
                    </div>
                  </div>
                  ...
                  <input
                    ...
                    placeholder={`Your ${formData.socialProvider === 'google' ? 'Google ID' : 'KingsChat Handle'}`}
                    className="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-purple-600 text-sm"
                    required
                  />
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <input
                    ...
                    onChange={handleInputChange}
                    className="px-4 py-4 bg-gray-100 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-purple-600 text-sm"
                    required
                  />
                  <input
                    type="text"
                ...
                <div className="grid grid-cols-2 gap-3">
                  <select
                    ...
                    onChange={handleInputChange}
                    className="px-4 py-4 bg-gray-100 border border-gray-200 rounded-xl text-gray-900 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-purple-600 text-sm"
                    required
                  >
