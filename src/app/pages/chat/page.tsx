        ...
        <div className="space-y-4">
          ...
          {isSending && (
            <div className="flex justify-end mb-2 animate-fade-in">
              <div className="flex items-end gap-3">
                <div className="bg-gradient-to-r from-purple-600 to-purple-700 px-4 py-3 rounded-2xl rounded-br-md shadow-lg">
                  <div className="flex gap-1">
            ...
            <button
              ...
              className={`w-12 h-12 rounded-full flex items-center justify-center transition-all duration-200 ${
                input.trim() && !isSending
                  ? 'bg-gradient-to-r from-purple-600 to-purple-700 text-white hover:from-purple-700 hover:to-purple-800 shadow-lg hover:scale-105 active:scale-95'
