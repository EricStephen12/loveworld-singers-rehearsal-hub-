    ...
    return (
      <div className="flex flex-col h-screen bg-gray-50">
            ...
            return (
              ...
              >
                <div className={`flex max-w-xs lg:max-w-md ${isOwn ? 'flex-row-reverse' : 'flex-row'}`}>
                  {!isOwn && showAvatar && (
                    <div className="w-8 h-8 bg-gradient-to-br from-purple-400 to-purple-500 rounded-full flex items-center justify-center mr-2 mt-1">
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 z-50">
          {/* Reply Preview */}
          {replyToMessage && (
            <div className="mb-2 bg-purple-50 border-l-4 border-purple-500 p-2 rounded flex items-center justify-between">
              <div className="flex-1">
                <p className="text-xs text-purple-500 font-medium">Replying to</p>
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="flex-1 relative">
              <input
                ...
                placeholder="Message..."
                className="w-full px-4 py-2 bg-gray-100 rounded-full text-sm focus:outline-none focus:bg-white focus:ring-2 focus:ring-purple-400"
              />
            </div>
